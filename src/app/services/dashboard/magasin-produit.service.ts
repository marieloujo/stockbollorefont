...
export class MagasinProduitService {
  ...
  createMagasinProduit(magasinProduit: MagasinProduit): Observable<Object> {
    return this.http.post(`${this.url}/creer-magazin-produit`, magasinProduit, this.http_get_request());
  }

  updateMagasinProduit(magasinProduit: MagasinProduit): Observable<Object> {
    return this.http.put(`${this.url}/modifier-magazin-produit`, magasinProduit, this.http_get_request());
  }

  deleteMagasinProduit(id: number): Observable<Object> {
    return this.http.delete(`${this.url}/supprimer-magazin-produit/${id}`, this.http_get_request());
  }
