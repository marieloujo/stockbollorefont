...
export class EtatProduitService {
  ...
  createEtatProduit(etatProduit: EtatProduit): Observable<Object> {
    return this.http.post(`${this.url}/creer-etat-produit`, etatProduit, this.http_get_request());
  }

  updateEtatProduit(etatProduit: EtatProduit): Observable<Object> {
    return this.http.put(`${this.url}/modifier-etat-produit`, etatProduit, this.http_get_request());
  }

  deleteEtatProduit(id: number): Observable<Object> {
    return this.http.delete(`${this.url}/supprimer-etat-produit/${id}`, this.http_get_request());
  }
